...
public class PublicController {
    ...
    public ResponseEntity<String> handleContactForm(@RequestBody ContactDTO request) {
        try {
            ...
            contactMessage.setCreatedAt(ZonedDateTime.now(IST_ZONE).toLocalDateTime());
            contactMessage.setMessage(request.getMessage());
        ...
        try {
            ...
            if (existingActiveUsage.isPresent()) {
                ...
                if (currentUsage.getOrder().getId().equals(order.getId())) {
                    ...
                    currentUsage.setCourgationOut(ZonedDateTime.now(IST_ZONE).toLocalDateTime());
            ...
            newOrderReelUsage.setCourgationIn(ZonedDateTime.now(IST_ZONE).toLocalDateTime());
    ...
    public ResponseEntity<String> calculateWeight(@RequestBody CalculationDTO calculationDTO) {
        try {
            ...
            orderReelUsage.setCourgationOut(ZonedDateTime.now(IST_ZONE).toLocalDateTime());
            ...
            reelUsageHistory.setUsedAt(ZonedDateTime.now(IST_ZONE).toLocalDateTime());
